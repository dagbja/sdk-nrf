...
#define CONFIG_NRF_COAP_OBSERVE_MAX_NUM_OBSERVERS 8
#define CONFIG_NRF_COAP_MAX_NUMBER_OF_OPTIONS 8
#define CONFIG_NRF_COAP_MAX_RETRANSMIT_COUNT 2
#define CONFIG_NRF_COAP_MAX_TRANSMISSION_SPAN 10
#define CONFIG_NRF_COAP_MESSAGE_DATA_MAX_SIZE 1024
#define CONFIG_NRF_COAP_MESSAGE_QUEUE_SIZE 4
#define CONFIG_NRF_COAP_PORT_COUNT 0
#define CONFIG_NRF_COAP_SESSION_COUNT 2
#define CONFIG_NRF_COAP_RESOURCE_MAX_DEPTH 4
...
#define COAP_CON_NOTIFICATION_INTERVAL CONFIG_NRF_COAP_CON_NOTIFICATION_INTERVAL
 ...
 */
typedef void (*coap_response_callback_t)(uint32_t status, void *arg,
					 coap_message_t *message);
 ...
 */
typedef uint32_t (*coap_request_handler_t)(coap_message_t *request);
 ...
 */
uint32_t coap_init(uint32_t token_rand_seed, coap_transport_init_t *transport_params,
 ...
 *                          to uint32_t. The value of the data is used to determine
 ...
 */
uint32_t coap_security_destroy(coap_transport_handle_t handle);
